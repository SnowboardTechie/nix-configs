...
| hermes | 9119 (Studio Tailscale only) | Nix client package + managed macOS venv for Matrix | Always-on on Studio | Studio runs the only gateway and remote backend; MBP/gnarbox/inix are clients only. |
